...
<body style ="background-color: #C0C0C0">
	...
	<%
		...
		String CurrentDate1 = request.getParameter("dateofsaleverify");
		...
		while(myRs5.next()) {
			...
			String transactionId = myRs5.getString(9);
	...
	<script type="text/javascript">
		function MarkAsVerified(){
			<%
				String somedate = request.getParameter("dateofsaleverify");
				//String somedate = "2020-08-10";
				String updatequery = "update dailysale set IsVerified=true where DateOfSale = ?";
