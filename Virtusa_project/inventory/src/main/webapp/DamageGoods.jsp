...
<%
		...
		String transactionid = request.getParameter("transactionid3");
		...
		if(isIncoming){
			...
			while(rs.next()) {
					...
					String query = "insert into damagegoods values(?,?)";
					PreparedStatement myPs5 = myConn.prepareStatement(query);
					myPs5.setString(1,ProductId);
					myPs5.setString(2,transactionid);
